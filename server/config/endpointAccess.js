...
const ENDPOINT_ACCESS = {
  ...
  JWT_AUTH: [
    ...
    // Admin endpoints - System Configuration (Super-Admin only)
    { method: "GET", path: "/api/admin/config" },
    { method: "GET", path: "/api/admin/config/categories" },
    { method: "GET", path: "/api/admin/config/category/:category" },
    { method: "GET", path: "/api/admin/config/audit/log" },
    { method: "GET", path: "/api/admin/config/export/all" },
    { method: "GET", path: "/api/admin/config/:id" },
    { method: "PUT", path: "/api/admin/config/:id" },
    { method: "PUT", path: "/api/admin/config/bulk/update" },
    { method: "POST", path: "/api/admin/config/:id/reset" },
    { method: "POST", path: "/api/admin/config/category/:category/reset" },
    { method: "POST", path: "/api/admin/config/reload" },
    { method: "POST", path: "/api/admin/config/import" },
    // Admin endpoints - Rate Limiting (Super-Admin only)
    { method: "GET", path: "/api/admin/rate-limits" },
    { method: "GET", path: "/api/admin/rate-limits/target-types" },
    { method: "GET", path: "/api/admin/rate-limits/statistics" },
    { method: "GET", path: "/api/admin/rate-limits/:id" },
    { method: "POST", path: "/api/admin/rate-limits" },
    { method: "PUT", path: "/api/admin/rate-limits/:id" },
    { method: "DELETE", path: "/api/admin/rate-limits/:id" },
    { method: "PATCH", path: "/api/admin/rate-limits/:id/toggle" },
    { method: "POST", path: "/api/admin/rate-limits/reset/user/:userId" },
    { method: "POST", path: "/api/admin/rate-limits/reset/all" },
